...
{ // ✅ Đảm bảo namespace của bạn đúng
    public class IndexModelNhanVien : PageModel
    {
        ...
        public IndexModelNhanVien(IConfiguration configuration, IHttpContextAccessor httpContextAccessor, ILogger<IndexModel> logger)
        {
